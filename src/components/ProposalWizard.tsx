                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 min-[550px]:grid-cols-5 gap-1.5 p-1 bg-slate-50/85 border border-slate-200/50 rounded-2xl">
                          {(['core', 'features', 'integrations', 'analytics', 'custom'] as const).map((cat) => {
                            ...
                            const allScopeItems = (proposal.websiteScope.scopeItems && Array.isArray(proposal.websiteScope.scopeItems))
                            ...
                            const catItems = allScopeItems.filter(i => getScopeCategory(i.title, i.isCustom, i.category) === cat);
                        ...
                        <div className="space-y-3">
                          {(() => {
                            ...
                            const filteredItems = allScopeItems.filter(item => getScopeCategory(item.title, item.isCustom, item.category) === activeScopeTab);
